      ...
      <Router>
        <div className="container">
          <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="https://beta.acnapi.io/#!/" target="_blank">
              <img src={logo} width="100" height="30" alt="ACNAPI" />
            </a>
            <Link to="/restricted" className="navbar-brand">Ticket Dashboard</Link>
            <div className="collpase navbar-collapse">
              <ul className="navbar-nav mr-auto">
                <li className="navbar-item">
                  <Link to="/restricted" className="nav-link">Manage Tickets</Link>
                </li>
                <li className="navbar-item">
