...
describe("POST /ticket/add", () => {
    ...
    it("should create a new ticket with single fileUpload", done => {
        ...
        request(app)
            ...
            .attach(
                "fileUpload",
                "/Users/seanlew/Desktop/conductor-support-ticket/server/images/philly.jpg"
            )
            .expect(200)
            .expect(res => {
                expect(res.body.createdBy).toBe(createdBy);
    ...
    it("should create a new ticket with multiple fileUploads", done => {
        ...
        request(app)
            ...
            .attach(
                "fileUpload",
                "/Users/seanlew/Desktop/conductor-support-ticket/server/images/profile-pic.jpg"
            )
            .attach(
                "fileUpload",
                "/Users/seanlew/Desktop/conductor-support-ticket/server/images/philly.jpg"
    ...
    it("should return 400 with invalid file format", done => {
        ...
        request(app)
            ...
            .attach(
                "fileUpload",
                "/Users/seanlew/Desktop/conductor-support-ticket/server/images/test.txt"
            )
            .expect(400)
            .end(done);
    });
    ...
    it("should return 400 if file is too large", done => {
        ...
        request(app)
            ...
            .attach(
                "fileUpload",
                "/Users/seanlew/Desktop/conductor-support-ticket/server/images/fall.jpg"
            )
            .expect(400)
            .expect(res => {
