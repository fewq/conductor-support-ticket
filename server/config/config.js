...
if (env === 'development') {
   ...
   process.env.MONGODB_URI = 'mongodb://0.0.0.0:27017/TicketManager', {useNewUrlParser:true};
} else if (env === 'test') {
   process.env.PORT = 3000;
   process.env.MONGODB_URI = 'mongodb://0.0.0.0:27017/TicketManagerTest', {useNewUrlParser:true};
} else {
